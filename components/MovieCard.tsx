...
export default function MovieCard({ movie, locale, variant = 'default' }: Props) {
  ...
  // ── Default variant ──────────────────────────────────────────
  return (
    <Link href={href} className="group flex flex-col rounded-2xl overflow-hidden bg-gray-900/80 border border-gray-800/60 hover:border-amber-500/40 transition-all duration-300 shine-card card-glow">
      {/* Poster */}
